...
TOKEN_LIFETIME_SECONDS_ENV_VAR = "STUDYGRAPH_TOKEN_LIFETIME_SECONDS"
ANSWER_MAX_REQUESTS_ENV_VAR = "STUDYGRAPH_ANSWER_MAX_REQUESTS"
ANSWER_RATE_WINDOW_SECONDS_ENV_VAR = "STUDYGRAPH_ANSWER_RATE_WINDOW_SECONDS"
...
ANSWER_MAX_CONTEXT_CHARACTERS_ENV_VAR = "STUDYGRAPH_ANSWER_MAX_CONTEXT_CHARACTERS"
ANSWER_MAX_OUTPUT_TOKENS_ENV_VAR = "STUDYGRAPH_ANSWER_MAX_OUTPUT_TOKENS"
ANSWER_MAX_OUTPUT_CHARACTERS_ENV_VAR = "STUDYGRAPH_ANSWER_MAX_OUTPUT_CHARACTERS"
METRICS_ENABLED_ENV_VAR = "STUDYGRAPH_METRICS_ENABLED"
...
DEFAULT_ANSWER_MAX_REQUESTS = 30
DEFAULT_ANSWER_RATE_WINDOW_SECONDS = 300
...
DEFAULT_ANSWER_MAX_CONTEXT_CHARACTERS = 12_000
DEFAULT_ANSWER_MAX_OUTPUT_TOKENS = 600
DEFAULT_ANSWER_MAX_OUTPUT_CHARACTERS = 6_000
...
def get_token_lifetime_seconds() -> int:
    return _get_positive_int_from_env(
        TOKEN_LIFETIME_SECONDS_ENV_VAR,
        DEFAULT_TOKEN_LIFETIME_SECONDS,
    )


def get_answer_max_requests() -> int:
    return _get_positive_int_from_env(
        ANSWER_MAX_REQUESTS_ENV_VAR,
        DEFAULT_ANSWER_MAX_REQUESTS,
    )


def get_answer_rate_window_seconds() -> int:
    return _get_positive_int_from_env(
        ANSWER_RATE_WINDOW_SECONDS_ENV_VAR,
        DEFAULT_ANSWER_RATE_WINDOW_SECONDS,
    )
...
def get_answer_max_context_characters() -> int:
    return _get_positive_int_from_env(
        ANSWER_MAX_CONTEXT_CHARACTERS_ENV_VAR,
        DEFAULT_ANSWER_MAX_CONTEXT_CHARACTERS,
    )


def get_answer_max_output_tokens() -> int:
    return _get_positive_int_from_env(
        ANSWER_MAX_OUTPUT_TOKENS_ENV_VAR,
        DEFAULT_ANSWER_MAX_OUTPUT_TOKENS,
    )


def get_answer_max_output_characters() -> int:
    return _get_positive_int_from_env(
        ANSWER_MAX_OUTPUT_CHARACTERS_ENV_VAR,
        DEFAULT_ANSWER_MAX_OUTPUT_CHARACTERS,
    )
...
def get_metrics_enabled() -> bool:
    raw_value = os.environ.get(
        ...
        str(DEFAULT_METRICS_ENABLED).lower(),
    )
    normalized_value = raw_value.strip().lower()
    if normalized_value in {"1", "true", "yes", "on"}:
        return True
    if normalized_value in {"0", "false", "no", "off"}:
        return False
    raise ConfigurationError(f"{METRICS_ENABLED_ENV_VAR} must be a boolean value.")
